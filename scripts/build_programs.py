...
PROGRAMS = [
    {
        ...
        "hub_blurb": "Ages 3–15 in three separated groups, six days a week. Gi, No-Gi and MMA, belt progression tracked, free trials Friday and Saturday.",
        "nav_name": "Kids BJJ",
        ...
        "faqs": [
            ...
            ("What is the difference between the regular and the advanced kids classes?",
             "The advanced grappling classes (Tuesday and Thursday at 5:15 PM, and Saturday at 12:00 PM) need a gray-white belt or higher, or two or more years of wrestling. They move faster and drill at a higher intensity. Every other class on the timetable is open to a complete beginner."),
        ],
    ...
    },
    {
        ...
        "groups": [
            ("6:30 AM", "Mornings",
             "Monday to Thursday, before work. Gi on Monday and Wednesday, No-Gi on Tuesday and Thursday. It is the class people are most skeptical about and the one they end up building the week around."),
            ("11:00 AM", "Middays",
    ...
    },
    {
        ...
        "facts": [
            ...
            ("Gold medals", "<em>%s</em> on jits.gg" % jits_data.n(jits_data.GOLDS)),
        ...
        "intro": [
            ...
            "Ours is ranked <strong>#%d of %s academies nationally</strong>, the top 1%%, on jits.gg, which is the largest verified youth grappling database there is. The ranking is computed from actual match results rather than claimed, and the team holds %s." % (jits_data.NATIONAL_RANK, jits_data.n(jits_data.NATIONAL_OF), jits_data.rivals_line()) + " Our athletes compete at <strong>IBJJF, ADCC and JJWL</strong> events, and the youth side of the team has produced Pan American champions.",
        ...
        "groups": [
            ...
            ("Adults", "Adult competition",
             "Friday evening in the Gi. Open to any adult member who wants harder rounds, whether or not they intend to enter anything."),
            ("Gray-white belt+", "Advanced grappling",
             "Tuesday, Thursday and Saturday. These sessions need a gray-white belt or higher, or two or more years of wrestling, not as a status symbol, but because the pace assumes you already know how to move."),
        ],
        "schedule_title": "Competition and advanced class times",
        "schedule_note": "Classes marked <strong>ADV</strong> require a gray-white belt or above, or two or more years of wrestling experience. The Friday competition classes are open to any member in the right age group. All of these are <strong>included in unlimited memberships</strong> (adult unlimited at $199/month and kids unlimited at $249/month) at no extra charge.",
        ...
        "prices_note": "Competition classes are part of the unlimited memberships rather than a separate team fee. Tournament entry fees are paid to the organizers directly and are not charged by the academy.",
        "faqs": [
            ...
            ("What does the jits.gg ranking actually mean?",
             "It comes from jits.gg, which aggregates verified match results across tournaments and ranks academies on the performance of their athletes. Wins, medals and submission rates, not self-reporting. We currently sit #%d of %s academies nationally, the top 1%%, with %d individually ranked athletes and %s golds." % (jits_data.NATIONAL_RANK, jits_data.n(jits_data.NATIONAL_OF), jits_data.RANKED, jits_data.n(jits_data.GOLDS))),
    ...
    },
    {
        ...
        "body": [
            ...
            "<strong>Bring lunch, shorts, a t-shirt and a water bottle.</strong> No gi needed. We will lend one for the jiu-jitsu block if your child does not own one. Nails trimmed, no jewelry.",
        ...
        "faqs": [
            ...
            ("What should my child bring?",
             "A packed lunch, a water bottle, shorts with no zippers or pockets, and a t-shirt or rashguard. No gi needed. We will lend one for the jiu-jitsu block. Nails trimmed, no jewelry."),
