...
PROGRAMS = [
    ...
    },
    {
        ...
        "description": "Adult Brazilian jiu-jitsu classes in Fulshear, TX. Gi and No-Gi, morning, midday and evening, seven days a week. Complete beginners welcome and your first class is free.",
    ...
    },
    {
        ...
        "description": "Competition BJJ training in Fulshear, TX for kids, teens and adults. IBJJF, ADCC and JJWL competitors, #1 ranked academy in Texas and #9 nationally. Included in unlimited memberships.",
...
def render_hub():
    ...
    head = HEAD % {
        ...
        "description": "Every program at Labyrinth BJJ in Fulshear, TX: kids BJJ ages 3-15, adult Gi and No-Gi, the competition team, youth wrestling and all-ages strength and conditioning.",
        "url": url,
