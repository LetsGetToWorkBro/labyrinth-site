...
<section class="hero ennova-hero">
  <div class="hero__bg">
    <picture class="hero__still"><source srcset="/assets/strength-conditioning-class.webp" type="image/webp"><img src="/assets/strength-conditioning-class.jpg" alt="One strength and conditioning session at Labyrinth BJJ in Fulshear, Texas: adults and children from about five years old up, training together in the same class" loading="eager" fetchpriority="high" width="1200" height="800"></picture>
  </div>
