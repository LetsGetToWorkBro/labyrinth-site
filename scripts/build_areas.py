...
AREAS = [
    ...
    },
    {
        ...
        "timing": "The 5:15 PM kids classes and the 6:30 PM adult classes are the realistic weekday options. If the drive is going to be twice a week, Saturday morning (kids from 9:00 AM, adults at 11:00) makes the second trip do more work.",
        "faqs": [
            ...
            ("Which classes suit a Richmond family best?",
             "Weekday evenings if you are coming once or twice, and Saturday morning if you want a single trip to cover more. Our Saturday runs kids from 9:00 AM to noon and adults at 11:00, so a family can train on one journey."),
        ],
    },
    {
    ...
    },
    {
        ...
        "faqs": [
            ...
            ("What is the best way to train here if I live in Rosenberg?",
             "Build the week around Saturday. Kids from 9:00 AM to noon, adults at 11:00, so a parent and child can both train on one journey. Sunday open mat at 10:30 adds a second session without a second weekday drive."),
    ...
    },
    {
        ...
        "body": [
            ...
            "What does work is one deliberate trip. Our Saturday runs kids from 9:00 AM to noon and adults at 11:00. A whole family can train on a single journey, and it is the same coaching the weekday classes get. Sunday adds open mat at 10:30 and youth wrestling at 1:00 PM if you want a second.",
        ...
        "faqs": [
            ...
            ("Is it realistic to train here from Sealy?",
             "As a weekend habit, yes, and several families do exactly that. As a four-evenings-a-week habit, no. Build it around Saturday (kids from 9:00 AM to noon, adults at 11:00, so nobody makes the drive alone) and add Sunday if you want more."),
